...
open build/BrewManager-5.1.dmg
```
...
Push a version tag that matches `CFBundleShortVersionString`; the Release
...
example, tag `v5.1` requires the bundle version to be `5.1`, and the release
asset will be `BrewManager-5.1.dmg`.
